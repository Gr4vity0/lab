...
//Metabox pour Icones post type -> Projets
...
function mytheme_add_box1() {
	...
	foreach($post_types as $type){
		...
		add_meta_box($meta_box['id'], $meta_box['title'], 'fontawesome_meta_box', 'projets', $meta_box['context'], $meta_box['priority']);
	}
}
// Callback function to show fields in meta box
function fontawesome_meta_box1() {
...
add_action('wp_enqueue_scripts','fontawesome_style1');
add_action('admin_enqueue_scripts','fontawesome_style1');
//theme template tag
function fontawesome_icon2(){
	global $prefix;
	global $post;
